...
const { FiDollarSign, FiTrendingUp, FiCreditCard, FiShoppingCart, FiTarget, FiRepeat } = FiIcons;

const RevenueMetricsWidget = ({ analytics }) => {
  const revenueData = [
    {
    ...
    },
    {
      ...
      value: '$127.50',
      change: 8.7,
      description: 'Average course purchase',
      icon: FiShoppingCart,
      color: 'blue'
    },
    {
    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Financial performance overview</p>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-sm text-green-600 font-medium">
              +{analytics.revenueGrowth}% this period
            </div>
          </div>
        </div>
